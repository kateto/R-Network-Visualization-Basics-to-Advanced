...
##    Sunbelt 2016 Workshop, Newport Beach CA             ##
##                                                        ##
##    Katya Ognyanova, katya@ognyanova.net                ##
##    www.kateto.net/sunbelt2016                          ##
##                                                        ##
##========================================================##
...
# Download handouts and example data: bit.ly/sunbelt16-r 
# An online version of the tutorial will be available at 
# kateto.net/sunbelt2016
...
# LIBRARIES
#
# Key packages to install if you do not have the latest versions: 
# (do not load those yet!)
...
# Optional packages that you might install if you
# would like to run all of the examples below
# (those are not critical and can be skipped)
...
# Download the archive with the data files from http://bit.ly/sunbelt16-r  
...
# click on network elements) - note that those take html.
...
# any time during that period, 'all' active the entire period, etc.
...
# Library 'maps' has built-in maps it can plot for you. For example:
par(mfrow = c(2,2))
